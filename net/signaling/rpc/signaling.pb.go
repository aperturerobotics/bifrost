...
// source: github.com/s4wave/spacewave/net/signaling/rpc/signaling.proto
...
func (m *ListenResponse) CloneVT() *ListenResponse {
	...
	if m.Body != nil {
		r.Body = m.Body.(interface{ CloneOneofVT() isListenResponse_Body }).CloneOneofVT()
	}
	if len(m.unknownFields) > 0 {
		r.unknownFields = slices.Clone(m.unknownFields)
	}
...
func (m *ListenResponse_SetPeer) CloneOneofVT() isListenResponse_Body {
	return m.CloneVT()
}
...
func (m *ListenResponse_ClearPeer) CloneOneofVT() isListenResponse_Body {
	return m.CloneVT()
}
...
func (m *SessionRequest) CloneVT() *SessionRequest {
	...
	if m.Body != nil {
		r.Body = m.Body.(interface{ CloneOneofVT() isSessionRequest_Body }).CloneOneofVT()
	}
	if len(m.unknownFields) > 0 {
		r.unknownFields = slices.Clone(m.unknownFields)
	}
...
func (m *SessionRequest_Init) CloneOneofVT() isSessionRequest_Body {
	return m.CloneVT()
}
...
func (m *SessionRequest_SendMsg) CloneVT() *SessionRequest_SendMsg {
	...
	r.SendMsg = protobuf_go_lite.CloneVTValue(m.SendMsg)
	return r
}

func (m *SessionRequest_SendMsg) CloneOneofVT() isSessionRequest_Body {
	return m.CloneVT()
}
...
func (m *SessionRequest_ClearMsg) CloneOneofVT() isSessionRequest_Body {
	return m.CloneVT()
}
...
func (m *SessionRequest_AckMsg) CloneOneofVT() isSessionRequest_Body {
	return m.CloneVT()
}
...
func (m *SessionMsg) CloneVT() *SessionMsg {
	...
	r := new(SessionMsg)
	r.Seqno = m.Seqno
	r.SignedMsg = protobuf_go_lite.CloneVTValue(m.SignedMsg)
	if len(m.unknownFields) > 0 {
		r.unknownFields = slices.Clone(m.unknownFields)
	}
	return r
...
func (m *SessionResponse) CloneVT() *SessionResponse {
	...
	if m.Body != nil {
		r.Body = m.Body.(interface{ CloneOneofVT() isSessionResponse_Body }).CloneOneofVT()
	}
	if len(m.unknownFields) > 0 {
		r.unknownFields = slices.Clone(m.unknownFields)
	}
...
func (m *SessionResponse_Opened) CloneOneofVT() isSessionResponse_Body {
	return m.CloneVT()
}
...
func (m *SessionResponse_Closed) CloneOneofVT() isSessionResponse_Body {
	return m.CloneVT()
}
...
func (m *SessionResponse_RecvMsg) CloneVT() *SessionResponse_RecvMsg {
	...
	r.RecvMsg = protobuf_go_lite.CloneVTValue(m.RecvMsg)
	return r
}

func (m *SessionResponse_RecvMsg) CloneOneofVT() isSessionResponse_Body {
	return m.CloneVT()
}
...
func (m *SessionResponse_ClearMsg) CloneOneofVT() isSessionResponse_Body {
	return m.CloneVT()
}
...
func (m *SessionResponse_AckMsg) CloneOneofVT() isSessionResponse_Body {
	return m.CloneVT()
}
...
func (this *SessionRequest_Init) EqualVT(thatIface isSessionRequest_Body) bool {
	...
	if !protobuf_go_lite.EqualVTImplicit(this.Init, that.Init, func() *SessionInit { return &SessionInit{} }) {
		return false
	}
	return true
}
...
func (this *SessionRequest_SendMsg) EqualVT(thatIface isSessionRequest_Body) bool {
	...
	if !protobuf_go_lite.EqualVTImplicit(this.SendMsg, that.SendMsg, func() *SessionMsg { return &SessionMsg{} }) {
		return false
	}
	return true
}
...
func (this *SessionMsg) EqualVT(that *SessionMsg) bool {
	...
	if !protobuf_go_lite.IsEqualVT(this.SignedMsg, that.SignedMsg) {
		return false
	}
...
func (this *SessionResponse_RecvMsg) EqualVT(thatIface isSessionResponse_Body) bool {
	...
	if !protobuf_go_lite.EqualVTImplicit(this.RecvMsg, that.RecvMsg, func() *SessionMsg { return &SessionMsg{} }) {
		return false
	}
	return true
}
...
func (m *ListenResponse_SetPeer) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	i := len(dAtA)
	i = protobuf_go_lite.EncodeString(dAtA, i, m.SetPeer)
	i--
	dAtA[i] = 0xa
	return len(dAtA) - i, nil
}
...
func (m *ListenResponse_ClearPeer) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	i := len(dAtA)
	i = protobuf_go_lite.EncodeString(dAtA, i, m.ClearPeer)
	i--
	dAtA[i] = 0x12
	return len(dAtA) - i, nil
}
...
func (m *ListenResponse_SetPeer) SizeVT() (n int) {
	...
	var l int
	_ = l
	n += protobuf_go_lite.SizeStringValue(1, m.SetPeer)
	return n
}
...
func (m *ListenResponse_ClearPeer) SizeVT() (n int) {
	...
	var l int
	_ = l
	n += protobuf_go_lite.SizeStringValue(1, m.ClearPeer)
	return n
}
...
func (m *SessionRequest) SizeVT() (n int) {
	...
	var l int
	_ = l
	n += protobuf_go_lite.SizeVarintNonZero(1, m.SessionSeqno)
	if vtmsg, ok := m.Body.(interface{ SizeVT() int }); ok {
		n += vtmsg.SizeVT()
	}
	n += len(m.unknownFields)
...
func (m *SessionRequest_ClearMsg) SizeVT() (n int) {
	...
	var l int
	_ = l
	n += protobuf_go_lite.SizeVarintValue(1, m.ClearMsg)
	return n
}
...
func (m *SessionRequest_AckMsg) SizeVT() (n int) {
	...
	var l int
	_ = l
	n += protobuf_go_lite.SizeVarintValue(1, m.AckMsg)
	return n
}
...
func (m *SessionResponse_Opened) SizeVT() (n int) {
	...
	var l int
	_ = l
	n += protobuf_go_lite.SizeVarintValue(1, m.Opened)
	return n
}
...
func (x *ListenRequest) MarshalProtoText() string {
	...
	protobuf_go_lite.TextStartMessage(&sb, "ListenRequest")
...
func (x *ListenResponse) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "ListenResponse")
	switch body := x.Body.(type) {
	case *ListenResponse_SetPeer:
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "set_peer")
		protobuf_go_lite.TextWriteString(&sb, body.SetPeer)
	case *ListenResponse_ClearPeer:
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "clear_peer")
		protobuf_go_lite.TextWriteString(&sb, body.ClearPeer)
	}
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (x *SessionRequest) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "SessionRequest")
	if x.SessionSeqno != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "session_seqno")
		protobuf_go_lite.TextWriteUint(&sb, x.SessionSeqno)
	}
	switch body := x.Body.(type) {
	case *SessionRequest_Init:
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "init")
		if body.Init == nil {
			protobuf_go_lite.TextWriteTextMarshaler(&sb, &SessionInit{})
		} else {
			protobuf_go_lite.TextWriteTextMarshaler(&sb, body.Init)
		}
	case *SessionRequest_SendMsg:
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "send_msg")
		if body.SendMsg == nil {
			protobuf_go_lite.TextWriteTextMarshaler(&sb, &SessionMsg{})
		} else {
			protobuf_go_lite.TextWriteTextMarshaler(&sb, body.SendMsg)
		}
	case *SessionRequest_ClearMsg:
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "clear_msg")
		protobuf_go_lite.TextWriteUint(&sb, body.ClearMsg)
	case *SessionRequest_AckMsg:
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "ack_msg")
		protobuf_go_lite.TextWriteUint(&sb, body.AckMsg)
	}
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (x *SessionInit) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "SessionInit")
	if x.PeerId != "" {
...
func (x *SessionMsg) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "SessionMsg")
	if x.SignedMsg != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "signed_msg")
		protobuf_go_lite.TextWriteTextMarshaler(&sb, x.SignedMsg)
	}
	if x.Seqno != 0 {
...
func (x *SessionResponse) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "SessionResponse")
	switch body := x.Body.(type) {
	case *SessionResponse_Opened:
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "opened")
		protobuf_go_lite.TextWriteUint(&sb, body.Opened)
	case *SessionResponse_Closed:
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "closed")
		protobuf_go_lite.TextWriteBool(&sb, body.Closed)
	case *SessionResponse_RecvMsg:
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "recv_msg")
		if body.RecvMsg == nil {
			protobuf_go_lite.TextWriteTextMarshaler(&sb, &SessionMsg{})
		} else {
			protobuf_go_lite.TextWriteTextMarshaler(&sb, body.RecvMsg)
		}
	case *SessionResponse_ClearMsg:
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "clear_msg")
		protobuf_go_lite.TextWriteUint(&sb, body.ClearMsg)
...
func (m *ListenResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Body = &ListenResponse_SetPeer{SetPeer: v}
		case 2:
			if wireType != 2 {
			...
			m.Body = &ListenResponse_ClearPeer{ClearPeer: v}
		default:
			iNdEx = preIndex
			skippy, err := protobuf_go_lite.Skip(dAtA[iNdEx:])
			if err != nil {
...
func (m *SessionRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.SessionSeqno = 0
			m.SessionSeqno, iNdEx, err = protobuf_go_lite.DecodeVarint(dAtA, iNdEx)
			if err != nil {
				return err
			}
		case 2:
		...
		case 3:
			...
			if oneof, ok := m.Body.(*SessionRequest_SendMsg); ok {
				if err := oneof.SendMsg.UnmarshalVT(dAtA[msgStart:postIndex]); err != nil {
					return err
				}
			} else {
				v := &SessionMsg{}
...
func (m *SessionMsg) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if err := m.SignedMsg.UnmarshalVT(dAtA[msgStart:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
	...
	for iNdEx < l {
		...
		case 3:
			...
			if oneof, ok := m.Body.(*SessionResponse_RecvMsg); ok {
				if err := oneof.RecvMsg.UnmarshalVT(dAtA[msgStart:postIndex]); err != nil {
					return err
				}
			} else {
				v := &SessionMsg{}
