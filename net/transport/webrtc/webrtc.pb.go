...
// source: github.com/s4wave/spacewave/net/transport/webrtc/webrtc.proto
...
type WebRtcSdp struct {
	...
	OfferId []byte `protobuf:"bytes,4,opt,name=offer_id,json=offerId,proto3" json:"offerId,omitempty"`
}
...
func (x *WebRtcSdp) GetOfferId() []byte {
	if x != nil {
		return x.OfferId
	}
	return nil
...
type WebRtcIce struct {
	...
	OfferId []byte `protobuf:"bytes,2,opt,name=offer_id,json=offerId,proto3" json:"offerId,omitempty"`
}
...
func (x *WebRtcIce) GetOfferId() []byte {
	if x != nil {
		return x.OfferId
	}
	return nil
...
func (m *Config) CloneVT() *Config {
	...
	r.BlockPeers = protobuf_go_lite.CloneSlice(m.BlockPeers)
...
func (m *WebRtcConfig) CloneVT() *WebRtcConfig {
	...
	r.IceServers = protobuf_go_lite.CloneVTSlice(m.IceServers)
	if len(m.unknownFields) > 0 {
		r.unknownFields = slices.Clone(m.unknownFields)
	}
	return r
...
func (m *IceServerConfig_Oauth) CloneVT() *IceServerConfig_Oauth {
	...
	r.Oauth = protobuf_go_lite.CloneVTValue(m.Oauth)
	return r
}
...
func (m *WebRtcSignal_Sdp) CloneVT() *WebRtcSignal_Sdp {
	...
	r.Sdp = protobuf_go_lite.CloneVTValue(m.Sdp)
	return r
}
...
func (m *WebRtcSignal_Ice) CloneVT() *WebRtcSignal_Ice {
	...
	r.Ice = protobuf_go_lite.CloneVTValue(m.Ice)
	return r
}
...
func (m *WebRtcSdp) CloneVT() *WebRtcSdp {
	...
	r.SdpType = m.SdpType
	r.Sdp = m.Sdp
	r.OfferId = protobuf_go_lite.CloneBytes(m.OfferId)
	if len(m.unknownFields) > 0 {
		r.unknownFields = slices.Clone(m.unknownFields)
	}
	return r
...
func (this *Config) EqualVT(that *Config) bool {
	...
	if !protobuf_go_lite.IsEqualVT(this.WebRtc, that.WebRtc) {
		return false
	}
	...
	if !protobuf_go_lite.EqualSlice(this.BlockPeers, that.BlockPeers) {
		return false
	}
...
func (this *WebRtcConfig) EqualVT(that *WebRtcConfig) bool {
	...
	if !protobuf_go_lite.EqualVTSliceImplicit(this.IceServers, that.IceServers, func() *IceServerConfig { return &IceServerConfig{} }) {
		return false
	}
...
func (this *IceServerConfig_Oauth) EqualVT(thatIface isIceServerConfig_Credential) bool {
	...
	if !protobuf_go_lite.EqualVTImplicit(this.Oauth, that.Oauth, func() *IceServerConfig_OauthCredential { return &IceServerConfig_OauthCredential{} }) {
		return false
	}
	return true
}
...
func (this *WebRtcSignal_Sdp) EqualVT(thatIface isWebRtcSignal_Body) bool {
	...
	if !protobuf_go_lite.EqualVTImplicit(this.Sdp, that.Sdp, func() *WebRtcSdp { return &WebRtcSdp{} }) {
		return false
	}
	return true
}
...
func (this *WebRtcSignal_Ice) EqualVT(thatIface isWebRtcSignal_Body) bool {
	...
	if !protobuf_go_lite.EqualVTImplicit(this.Ice, that.Ice, func() *WebRtcIce { return &WebRtcIce{} }) {
		return false
	}
	return true
}
...
func (this *WebRtcSdp) EqualVT(that *WebRtcSdp) bool {
	...
	if !protobuf_go_lite.EqualBytes(this.OfferId, that.OfferId) {
		return false
	}
	return string(this.unknownFields) == string(that.unknownFields)
}
...
func (x IceTransportPolicy) MarshalProtoJSON(s *json.MarshalState) {
	s.WriteEnum(int32(x), IceTransportPolicy_name)
}
...
func (x *WebRtcSdp) MarshalProtoJSON(s *json.MarshalState) {
	...
	if len(x.OfferId) > 0 || s.HasField("offerId") {
		s.WriteMoreIf(&wroteField)
		s.WriteObjectField("offerId")
		s.WriteBytes(x.OfferId)
	}
	s.WriteObjectEnd()
}
...
func (m *Config) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.BlockPeers) > 0 {
		for iNdEx := len(m.BlockPeers) - 1; iNdEx >= 0; iNdEx-- {
			i = protobuf_go_lite.EncodeString(dAtA, i, m.BlockPeers[iNdEx])
			i--
			dAtA[i] = 0x52
		}
	}
	...
	if m.AllPeers {
		i = protobuf_go_lite.EncodeBool(dAtA, i, m.AllPeers)
		i--
		dAtA[i] = 0x40
	}
	if len(m.Dialers) > 0 {
	...
	if len(m.TransportType) > 0 {
		i = protobuf_go_lite.EncodeString(dAtA, i, m.TransportType)
		i--
		dAtA[i] = 0x1a
	}
...
func (m *IceServerConfig_OauthCredential) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.MacKey) > 0 {
		i = protobuf_go_lite.EncodeString(dAtA, i, m.MacKey)
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *WebRtcSdp) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.OfferId) > 0 {
		i = protobuf_go_lite.EncodeBytes(dAtA, i, m.OfferId)
		i--
		dAtA[i] = 0x22
	}
	if len(m.Sdp) > 0 {
	...
	if len(m.SdpType) > 0 {
		i = protobuf_go_lite.EncodeString(dAtA, i, m.SdpType)
		i--
		dAtA[i] = 0x12
	}
	if m.TxSeqno != 0 {
...
func (m *WebRtcIce) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.Candidate) > 0 {
		i = protobuf_go_lite.EncodeString(dAtA, i, m.Candidate)
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *Config) SizeVT() (n int) {
	...
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.TransportType)
	if m.Quic != nil {
		l = m.Quic.SizeVT()
	...
	n += protobuf_go_lite.SizeBoolNonZero(1, m.AllPeers)
...
func (m *WebRtcConfig) SizeVT() (n int) {
	...
	n += protobuf_go_lite.SizeVarintNonZero(1, m.IceTransportPolicy)
	n += protobuf_go_lite.SizeVarintNonZero(1, m.IceCandidatePoolSize)
	n += len(m.unknownFields)
	return n
}
...
func (m *IceServerConfig_OauthCredential) SizeVT() (n int) {
	...
	var l int
	_ = l
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.MacKey)
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.AccessToken)
	n += len(m.unknownFields)
	return n
}
...
func (m *WebRtcSignal_RequestOffer) SizeVT() (n int) {
	...
	var l int
	_ = l
	n += protobuf_go_lite.SizeVarintValue(1, m.RequestOffer)
	return n
}
...
func (m *WebRtcSdp) SizeVT() (n int) {
	...
	var l int
	_ = l
	n += protobuf_go_lite.SizeVarintNonZero(1, m.TxSeqno)
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.SdpType)
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.Sdp)
	n += protobuf_go_lite.SizeBytesNonEmpty(1, m.OfferId)
	n += len(m.unknownFields)
	return n
}
...
func (m *WebRtcIce) SizeVT() (n int) {
	...
	var l int
	_ = l
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.Candidate)
	n += protobuf_go_lite.SizeBytesNonEmpty(1, m.OfferId)
	n += len(m.unknownFields)
	return n
}
...
func (x *Config) MarshalProtoText() string {
	...
	if x.TransportType != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "transport_type")
		protobuf_go_lite.TextWriteString(&sb, x.TransportType)
	}
	if x.Quic != nil {
	...
	if x.WebRtc != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "web_rtc")
		protobuf_go_lite.TextWriteTextMarshaler(&sb, x.WebRtc)
	}
	if x.Backoff != nil {
	...
	if x.AllPeers != false {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "all_peers")
		protobuf_go_lite.TextWriteBool(&sb, x.AllPeers)
	}
	...
	if len(x.BlockPeers) > 0 {
		protobuf_go_lite.TextWriteListStart(&sb, initialLen, "block_peers")
...
func (x *WebRtcConfig) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "WebRtcConfig")
	if len(x.IceServers) > 0 {
		protobuf_go_lite.TextWriteListStart(&sb, initialLen, "ice_servers")
		for i, v := range x.IceServers {
			protobuf_go_lite.TextWriteListSeparator(&sb, i)
			if v == nil {
				protobuf_go_lite.TextWriteTextMarshaler(&sb, &IceServerConfig{})
			} else {
				protobuf_go_lite.TextWriteTextMarshaler(&sb, v)
			}
		}
	...
	if x.IceTransportPolicy != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "ice_transport_policy")
		protobuf_go_lite.TextWriteStringer(&sb, IceTransportPolicy(x.IceTransportPolicy))
	}
	if x.IceCandidatePoolSize != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "ice_candidate_pool_size")
		protobuf_go_lite.TextWriteUint(&sb, x.IceCandidatePoolSize)
	}
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (x *IceServerConfig_OauthCredential) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "OauthCredential")
	if x.MacKey != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "mac_key")
		protobuf_go_lite.TextWriteString(&sb, x.MacKey)
	}
	if x.AccessToken != "" {
...
func (x *IceServerConfig) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "IceServerConfig")
	if len(x.Urls) > 0 {
	...
	case *IceServerConfig_Oauth:
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "oauth")
		if body.Oauth == nil {
			protobuf_go_lite.TextWriteTextMarshaler(&sb, &IceServerConfig_OauthCredential{})
		} else {
			protobuf_go_lite.TextWriteTextMarshaler(&sb, body.Oauth)
		}
	}
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (x *WebRtcSignal) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "WebRtcSignal")
	switch body := x.Body.(type) {
	case *WebRtcSignal_RequestOffer:
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "request_offer")
		protobuf_go_lite.TextWriteUint(&sb, body.RequestOffer)
	case *WebRtcSignal_Sdp:
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "sdp")
		if body.Sdp == nil {
			protobuf_go_lite.TextWriteTextMarshaler(&sb, &WebRtcSdp{})
		} else {
			protobuf_go_lite.TextWriteTextMarshaler(&sb, body.Sdp)
		}
	case *WebRtcSignal_Ice:
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "ice")
		if body.Ice == nil {
			protobuf_go_lite.TextWriteTextMarshaler(&sb, &WebRtcIce{})
		} else {
			protobuf_go_lite.TextWriteTextMarshaler(&sb, body.Ice)
		}
	}
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (x *WebRtcSdp) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "WebRtcSdp")
	if x.TxSeqno != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "tx_seqno")
		protobuf_go_lite.TextWriteUint(&sb, x.TxSeqno)
	}
	if x.SdpType != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "sdp_type")
		protobuf_go_lite.TextWriteString(&sb, x.SdpType)
	}
	if x.Sdp != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "sdp")
	...
	if len(x.OfferId) != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "offer_id")
		protobuf_go_lite.TextWriteBytes(&sb, x.OfferId)
	}
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (x *WebRtcIce) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "WebRtcIce")
	if x.Candidate != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "candidate")
		protobuf_go_lite.TextWriteString(&sb, x.Candidate)
	}
	if len(x.OfferId) != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "offer_id")
		protobuf_go_lite.TextWriteBytes(&sb, x.OfferId)
...
func (m *Config) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			if err := m.WebRtc.UnmarshalVT(dAtA[msgStart:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 6:
		...
		case 10:
			...
			m.BlockPeers = append(m.BlockPeers, v)
		case 11:
			if wireType != 0 {
...
func (m *WebRtcConfig) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if err := m.IceServers[len(m.IceServers)-1].UnmarshalVT(dAtA[msgStart:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
			...
			m.IceTransportPolicy = IceTransportPolicy(_v)
			if err != nil {
				return err
			}
		case 3:
			...
			m.IceCandidatePoolSize, iNdEx, err = protobuf_go_lite.DecodeVarintUint32(dAtA, iNdEx)
			if err != nil {
				return err
			}
		default:
...
func (m *IceServerConfig) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.Credential = &IceServerConfig_Password{Password: v}
		case 4:
			if wireType != 2 {
			...
			if oneof, ok := m.Credential.(*IceServerConfig_Oauth); ok {
				if err := oneof.Oauth.UnmarshalVT(dAtA[msgStart:postIndex]); err != nil {
					return err
				}
			} else {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if oneof, ok := m.Body.(*WebRtcSignal_Sdp); ok {
				if err := oneof.Sdp.UnmarshalVT(dAtA[msgStart:postIndex]); err != nil {
					return err
				}
			} else {
				v := &WebRtcSdp{}
		...
		case 3:
			...
			if oneof, ok := m.Body.(*WebRtcSignal_Ice); ok {
				if err := oneof.Ice.UnmarshalVT(dAtA[msgStart:postIndex]); err != nil {
					return err
				}
			} else {
				v := &WebRtcIce{}
...
func (m *WebRtcSdp) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.TxSeqno = 0
			m.TxSeqno, iNdEx, err = protobuf_go_lite.DecodeVarint(dAtA, iNdEx)
			if err != nil {
				return err
			}
		case 2:
		...
		case 4:
			...
			m.OfferId, iNdEx, err = protobuf_go_lite.DecodeBytesAppend(m.OfferId, dAtA, iNdEx)
			if err != nil {
				return err
			}
		default:
