...
export const Config = {
  ...
  fromJSON(object: any): Config {
    return { floodsubConfig: isSet(object.floodsubConfig) ? Config1.fromJSON(object.floodsubConfig) : undefined };
  },

  toJSON(message: Config): unknown {
    const obj: any = {};
    message.floodsubConfig !== undefined &&
      (obj.floodsubConfig = message.floodsubConfig ? Config1.toJSON(message.floodsubConfig) : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<Config>, I>>(object: I): Config {
    const message = createBaseConfig();
    message.floodsubConfig = (object.floodsubConfig !== undefined && object.floodsubConfig !== null)
