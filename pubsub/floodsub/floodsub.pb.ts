...
export const Config = {
  ...
  fromJSON(object: any): Config {
    return { publishHashType: isSet(object.publishHashType) ? hashTypeFromJSON(object.publishHashType) : 0 };
  },

  toJSON(message: Config): unknown {
    const obj: any = {};
    message.publishHashType !== undefined && (obj.publishHashType = hashTypeToJSON(message.publishHashType));
    return obj;
  },
...
export const Packet = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): Packet {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.subscriptions.push(SubscriptionOpts.decode(reader, reader.uint32()));
          break;
        case 2:
  ...
  fromJSON(object: any): Packet {
    return {
      subscriptions: Array.isArray(object?.subscriptions)
        ...
        : [],
      publish: Array.isArray(object?.publish) ? object.publish.map((e: any) => SignedMsg.fromJSON(e)) : [],
    };
  },
  ...
  toJSON(message: Packet): unknown {
    ...
    if (message.subscriptions) {
      obj.subscriptions = message.subscriptions.map((e) => e ? SubscriptionOpts.toJSON(e) : undefined);
    } else {
      obj.subscriptions = [];
    }
    if (message.publish) {
      obj.publish = message.publish.map((e) => e ? SignedMsg.toJSON(e) : undefined);
    } else {
      obj.publish = [];
    }
    return obj;
  ...
  fromPartial<I extends Exact<DeepPartial<Packet>, I>>(object: I): Packet {
    const message = createBasePacket();
    message.subscriptions = object.subscriptions?.map((e) => SubscriptionOpts.fromPartial(e)) || [];
...
export const SubscriptionOpts = {
  encode(message: SubscriptionOpts, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  async *encodeTransform(
    source: AsyncIterable<SubscriptionOpts | SubscriptionOpts[]> | Iterable<SubscriptionOpts | SubscriptionOpts[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
  ...
  fromPartial<I extends Exact<DeepPartial<SubscriptionOpts>, I>>(object: I): SubscriptionOpts {
    const message = createBaseSubscriptionOpts();
