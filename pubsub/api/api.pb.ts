...
function createBaseSubscribeRequest(): SubscribeRequest {
  return { channelId: "", peerId: "", privKeyPem: "", publishRequest: undefined };
}
...
export const SubscribeRequest = {
  encode(message: SubscribeRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.publishRequest !== undefined) {
      PublishRequest.encode(message.publishRequest, writer.uint32(34).fork()).ldelim();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          break;
        case 4:
          message.publishRequest = PublishRequest.decode(reader, reader.uint32());
          break;
        default:
  ...
  fromJSON(object: any): SubscribeRequest {
    return {
      ...
      publishRequest: isSet(object.publishRequest) ? PublishRequest.fromJSON(object.publishRequest) : undefined,
    };
  },
  ...
  toJSON(message: SubscribeRequest): unknown {
    ...
    message.publishRequest !== undefined &&
      (obj.publishRequest = message.publishRequest ? PublishRequest.toJSON(message.publishRequest) : undefined);
    return obj;
  },
...
function createBaseSubscribeResponse(): SubscribeResponse {
  return { incomingMessage: undefined, outgoingStatus: undefined, subscriptionStatus: undefined };
}
...
export const SubscribeResponse = {
  encode(message: SubscribeResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.incomingMessage !== undefined) {
      IncomingMessage.encode(message.incomingMessage, writer.uint32(10).fork()).ldelim();
    }
    if (message.outgoingStatus !== undefined) {
      OutgoingStatus.encode(message.outgoingStatus, writer.uint32(18).fork()).ldelim();
    }
    if (message.subscriptionStatus !== undefined) {
      SubscriptionStatus.encode(message.subscriptionStatus, writer.uint32(26).fork()).ldelim();
    }
    return writer;
  },
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): SubscribeResponse {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.incomingMessage = IncomingMessage.decode(reader, reader.uint32());
          break;
        case 2:
          message.outgoingStatus = OutgoingStatus.decode(reader, reader.uint32());
          break;
        case 3:
          message.subscriptionStatus = SubscriptionStatus.decode(reader, reader.uint32());
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromJSON(object: any): SubscribeResponse {
    return {
      incomingMessage: isSet(object.incomingMessage) ? IncomingMessage.fromJSON(object.incomingMessage) : undefined,
      outgoingStatus: isSet(object.outgoingStatus) ? OutgoingStatus.fromJSON(object.outgoingStatus) : undefined,
  ...
  toJSON(message: SubscribeResponse): unknown {
    ...
    message.incomingMessage !== undefined &&
      (obj.incomingMessage = message.incomingMessage ? IncomingMessage.toJSON(message.incomingMessage) : undefined);
    message.outgoingStatus !== undefined &&
      (obj.outgoingStatus = message.outgoingStatus ? OutgoingStatus.toJSON(message.outgoingStatus) : undefined);
  ...
  fromPartial<I extends Exact<DeepPartial<SubscribeResponse>, I>>(object: I): SubscribeResponse {
    const message = createBaseSubscribeResponse();
    message.incomingMessage = (object.incomingMessage !== undefined && object.incomingMessage !== null)
      ? IncomingMessage.fromPartial(object.incomingMessage)
      : undefined;
    message.outgoingStatus = (object.outgoingStatus !== undefined && object.outgoingStatus !== null)
      ? OutgoingStatus.fromPartial(object.outgoingStatus)
      : undefined;
    message.subscriptionStatus = (object.subscriptionStatus !== undefined && object.subscriptionStatus !== null)
...
export const SubscriptionStatus = {
  ...
  fromJSON(object: any): SubscriptionStatus {
    return { subscribed: isSet(object.subscribed) ? Boolean(object.subscribed) : false };
  },
...
export const OutgoingStatus = {
  encode(message: OutgoingStatus, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.identifier !== 0) {
  ...
  async *encodeTransform(
    source: AsyncIterable<OutgoingStatus | OutgoingStatus[]> | Iterable<OutgoingStatus | OutgoingStatus[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
  ...
  fromPartial<I extends Exact<DeepPartial<OutgoingStatus>, I>>(object: I): OutgoingStatus {
    const message = createBaseOutgoingStatus();
    message.identifier = object.identifier ?? 0;
...
export const IncomingMessage = {
  encode(message: IncomingMessage, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  async *encodeTransform(
    source: AsyncIterable<IncomingMessage | IncomingMessage[]> | Iterable<IncomingMessage | IncomingMessage[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
  ...
  fromPartial<I extends Exact<DeepPartial<IncomingMessage>, I>>(object: I): IncomingMessage {
    const message = createBaseIncomingMessage();
