...
func (x *SubscribeRequest) MarshalProtoText() string {
	...
	sb.WriteString("SubscribeRequest {")
	if x.ChannelId != "" {
		if sb.Len() > 18 {
			sb.WriteString(" ")
		}
	...
	if x.PublishRequest != nil {
		if sb.Len() > 18 {
			sb.WriteString(" ")
		}
		sb.WriteString("publish_request: ")
		sb.WriteString(x.PublishRequest.MarshalProtoText())
	}
	sb.WriteString("}")
	return sb.String()
}
...
func (x *PublishRequest) MarshalProtoText() string {
	...
	if x.Identifier != 0 {
		...
		sb.WriteString(strconv.FormatUint(uint64(x.Identifier), 10))
	}
	sb.WriteString("}")
	return sb.String()
}
...
func (x *SubscribeResponse) MarshalProtoText() string {
	var sb strings.Builder
	sb.WriteString("SubscribeResponse {")
	if x.IncomingMessage != nil {
		if sb.Len() > 19 {
			sb.WriteString(" ")
		}
		sb.WriteString("incoming_message: ")
		sb.WriteString(x.IncomingMessage.MarshalProtoText())
	}
	if x.OutgoingStatus != nil {
		if sb.Len() > 19 {
			sb.WriteString(" ")
		}
		sb.WriteString("outgoing_status: ")
		sb.WriteString(x.OutgoingStatus.MarshalProtoText())
	}
	if x.SubscriptionStatus != nil {
		if sb.Len() > 19 {
			sb.WriteString(" ")
		}
		sb.WriteString("subscription_status: ")
		sb.WriteString(x.SubscriptionStatus.MarshalProtoText())
	}
	sb.WriteString("}")
	return sb.String()
}
...
func (x *SubscriptionStatus) MarshalProtoText() string {
	...
	if x.Subscribed != false {
		...
		sb.WriteString("subscribed: ")
		sb.WriteString(strconv.FormatBool(x.Subscribed))
	}
	sb.WriteString("}")
	return sb.String()
}
...
func (x *OutgoingStatus) MarshalProtoText() string {
	...
	if x.Sent != false {
		...
		sb.WriteString("sent: ")
		sb.WriteString(strconv.FormatBool(x.Sent))
	}
	sb.WriteString("}")
	return sb.String()
}
...
func (x *IncomingMessage) MarshalProtoText() string {
	var sb strings.Builder
	sb.WriteString("IncomingMessage {")
	if x.FromPeerId != "" {
		if sb.Len() > 17 {
			sb.WriteString(" ")
		}
	...
	if x.Authenticated != false {
		...
		sb.WriteString(strconv.FormatBool(x.Authenticated))
	}
	if x.Data != nil {
		if sb.Len() > 17 {
			sb.WriteString(" ")
...
func (m *PublishRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Identifier = 0
			m.Identifier, iNdEx, err = protobuf_go_lite.DecodeVarintUint32(dAtA, iNdEx)
			if err != nil {
				return err
			}
		default:
