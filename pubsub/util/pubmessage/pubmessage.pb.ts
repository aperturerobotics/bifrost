...
export const PubMessageInner = {
  encode(message: PubMessageInner, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  async *encodeTransform(
    source: AsyncIterable<PubMessageInner | PubMessageInner[]> | Iterable<PubMessageInner | PubMessageInner[]>,
  ...
  fromPartial<I extends Exact<DeepPartial<PubMessageInner>, I>>(object: I): PubMessageInner {
    const message = createBasePubMessageInner();
