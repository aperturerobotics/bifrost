...
func (m *Config) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return errors.Errorf("proto: wrong wireType = %d for field ClusterName", wireType)
			}
		...
		case 3:
			if wireType != 0 {
				return errors.Errorf("proto: wrong wireType = %d for field LogDebug", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 4:
			if wireType != 0 {
				return errors.Errorf("proto: wrong wireType = %d for field LogTrace", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 5:
			if wireType != 0 {
				return errors.Errorf("proto: wrong wireType = %d for field LogTraceVerbose", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
