...
type SubscribeRequest struct {
	...
	PublishRequest       *PublishRequest `protobuf:"bytes,2,opt,name=publish_request,json=publishRequest" json:"publish_request,omitempty"`
...
func (*SubscribeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpc_098c44ce6d044894, []int{0}
}
...
type PublishRequest struct {
	...
	Identifier           uint32   `protobuf:"varint,3,opt,name=identifier" json:"identifier,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (*PublishRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpc_098c44ce6d044894, []int{1}
}
...
type SubscribeResponse struct {
	...
	IncomingMessage *IncomingMessage `protobuf:"bytes,1,opt,name=incoming_message,json=incomingMessage" json:"incoming_message,omitempty"`
	// OutgoingStatus is status of an outgoing message.
	// Sent when a Publish request finishes.
	OutgoingStatus *OutgoingStatus `protobuf:"bytes,2,opt,name=outgoing_status,json=outgoingStatus" json:"outgoing_status,omitempty"`
	// SubscriptionStatus is the status of the subscription
	SubscriptionStatus   *SubscriptionStatus `protobuf:"bytes,3,opt,name=subscription_status,json=subscriptionStatus" json:"subscription_status,omitempty"`
	XXX_NoUnkeyedLiteral struct{}            `json:"-"`
	XXX_unrecognized     []byte              `json:"-"`
	XXX_sizecache        int32               `json:"-"`
}
...
func (*SubscribeResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpc_098c44ce6d044894, []int{2}
}
...
func (*SubscriptionStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpc_098c44ce6d044894, []int{3}
}
...
func (*OutgoingStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpc_098c44ce6d044894, []int{4}
}
...
func (dst *OutgoingStatus) XXX_Merge(src proto.Message) {
	xxx_messageInfo_OutgoingStatus.Merge(dst, src)
}
...
func (*IncomingMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpc_098c44ce6d044894, []int{5}
}
...
func (c *pubSubServiceClient) Subscribe(ctx context.Context, opts ...grpc.CallOption) (PubSubService_SubscribeClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_PubSubService_serviceDesc.Streams[0], c.cc, "/pubsub.grpc.PubSubService/Subscribe", opts...)
	if err != nil {
		return nil, err
	}
...
func init() {
	proto.RegisterFile("github.com/aperturerobotics/bifrost/pubsub/grpc/grpc.proto", fileDescriptor_grpc_098c44ce6d044894)
}

var fileDescriptor_grpc_098c44ce6d044894 = []byte{
