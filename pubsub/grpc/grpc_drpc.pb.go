...
type drpcEncoding_File_github_com_aperturerobotics_bifrost_pubsub_grpc_grpc_proto struct{}

func (drpcEncoding_File_github_com_aperturerobotics_bifrost_pubsub_grpc_grpc_proto) Marshal(msg drpc.Message) ([]byte, error) {
	return proto.Marshal(msg)
}

func (drpcEncoding_File_github_com_aperturerobotics_bifrost_pubsub_grpc_grpc_proto) Unmarshal(buf []byte, msg drpc.Message) error {
...
func (c *drpcPubSubServiceClient) Subscribe(ctx context.Context) (DRPCPubSubService_SubscribeClient, error) {
	stream, err := c.cc.NewStream(ctx, "/pubsub.grpc.PubSubService/Subscribe", drpcEncoding_File_github_com_aperturerobotics_bifrost_pubsub_grpc_grpc_proto{})
	if err != nil {
		return nil, err
	}
...
func (x *drpcPubSubService_SubscribeClient) Send(m *SubscribeRequest) error {
	return x.MsgSend(m, drpcEncoding_File_github_com_aperturerobotics_bifrost_pubsub_grpc_grpc_proto{})
}

func (x *drpcPubSubService_SubscribeClient) Recv() (*SubscribeResponse, error) {
	m := new(SubscribeResponse)
	if err := x.MsgRecv(m, drpcEncoding_File_github_com_aperturerobotics_bifrost_pubsub_grpc_grpc_proto{}); err != nil {
		return nil, err
	}
	return m, nil
}
...
func (x *drpcPubSubService_SubscribeClient) RecvMsg(m *SubscribeResponse) error {
	return x.MsgRecv(m, drpcEncoding_File_github_com_aperturerobotics_bifrost_pubsub_grpc_grpc_proto{})
}
...
func (DRPCPubSubServiceDescription) Method(n int) (string, drpc.Encoding, drpc.Receiver, interface{}, bool) {
	switch n {
	case 0:
		return "/pubsub.grpc.PubSubService/Subscribe", drpcEncoding_File_github_com_aperturerobotics_bifrost_pubsub_grpc_grpc_proto{},
