...
func (PacketType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_s2s_f43b28514c938f9e, []int{0}
}
...
func (*Packet_Init) Descriptor() ([]byte, []int) {
	return fileDescriptor_s2s_f43b28514c938f9e, []int{0, 0}
}
...
func (*Packet_InitAck) Descriptor() ([]byte, []int) {
	return fileDescriptor_s2s_f43b28514c938f9e, []int{0, 1}
}
...
func (*Packet_Complete) Descriptor() ([]byte, []int) {
	return fileDescriptor_s2s_f43b28514c938f9e, []int{0, 2}
}
...
type Packet_Ciphertext struct {
	...
	// The signature is made using B's public key.
...
func (*Packet_Ciphertext) Descriptor() ([]byte, []int) {
	return fileDescriptor_s2s_f43b28514c938f9e, []int{0, 3}
}
...
func init() {
	proto.RegisterFile("github.com/aperturerobotics/bifrost/handshake/identity/s2s/s2s.proto", fileDescriptor_s2s_f43b28514c938f9e)
}

var fileDescriptor_s2s_f43b28514c938f9e = []byte{
	// 435 bytes of a gzipped FileDescriptorProto
	,
}
