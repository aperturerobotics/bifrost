...
function createBasePacket(): Packet {
  return { packetType: 0, initPkt: undefined, initAckPkt: undefined, completePkt: undefined };
}
...
export const Packet = {
  encode(message: Packet, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.initAckPkt !== undefined) {
      Packet_InitAck.encode(message.initAckPkt, writer.uint32(26).fork()).ldelim();
    }
    if (message.completePkt !== undefined) {
      Packet_Complete.encode(message.completePkt, writer.uint32(34).fork()).ldelim();
    }
    return writer;
  },
  ...
  fromJSON(object: any): Packet {
    return {
      packetType: isSet(object.packetType) ? packetTypeFromJSON(object.packetType) : 0,
      initPkt: isSet(object.initPkt) ? Packet_Init.fromJSON(object.initPkt) : undefined,
      initAckPkt: isSet(object.initAckPkt) ? Packet_InitAck.fromJSON(object.initAckPkt) : undefined,
      completePkt: isSet(object.completePkt) ? Packet_Complete.fromJSON(object.completePkt) : undefined,
    };
  },
  ...
  toJSON(message: Packet): unknown {
    ...
    message.initPkt !== undefined && (obj.initPkt = message.initPkt ? Packet_Init.toJSON(message.initPkt) : undefined);
    message.initAckPkt !== undefined &&
      (obj.initAckPkt = message.initAckPkt ? Packet_InitAck.toJSON(message.initAckPkt) : undefined);
    message.completePkt !== undefined &&
      (obj.completePkt = message.completePkt ? Packet_Complete.toJSON(message.completePkt) : undefined);
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Packet>, I>>(object: I): Packet {
    ...
    message.initPkt = (object.initPkt !== undefined && object.initPkt !== null)
      ? Packet_Init.fromPartial(object.initPkt)
      : undefined;
    message.initAckPkt = (object.initAckPkt !== undefined && object.initAckPkt !== null)
      ? Packet_InitAck.fromPartial(object.initAckPkt)
      : undefined;
    message.completePkt = (object.completePkt !== undefined && object.completePkt !== null)
...
function createBasePacket_Init(): Packet_Init {
  return { senderPeerId: new Uint8Array(), receiverPeerId: new Uint8Array(), senderEphPub: new Uint8Array() };
}

export const Packet_Init = {
  encode(message: Packet_Init, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  async *encodeTransform(
    source: AsyncIterable<Packet_Init | Packet_Init[]> | Iterable<Packet_Init | Packet_Init[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
  ...
  fromJSON(object: any): Packet_Init {
    return {
      ...
      receiverPeerId: isSet(object.receiverPeerId) ? bytesFromBase64(object.receiverPeerId) : new Uint8Array(),
      senderEphPub: isSet(object.senderEphPub) ? bytesFromBase64(object.senderEphPub) : new Uint8Array(),
    };
  },
  ...
  toJSON(message: Packet_Init): unknown {
    ...
    message.receiverPeerId !== undefined &&
      (obj.receiverPeerId = base64FromBytes(
        message.receiverPeerId !== undefined ? message.receiverPeerId : new Uint8Array(),
      ));
    message.senderEphPub !== undefined &&
      (obj.senderEphPub = base64FromBytes(
        message.senderEphPub !== undefined ? message.senderEphPub : new Uint8Array(),
      ));
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<Packet_Init>, I>>(object: I): Packet_Init {
    const message = createBasePacket_Init();
...
export const Packet_InitAck = {
  encode(message: Packet_InitAck, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.senderEphPub.length !== 0) {
  ...
  async *encodeTransform(
    source: AsyncIterable<Packet_InitAck | Packet_InitAck[]> | Iterable<Packet_InitAck | Packet_InitAck[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
  ...
  fromPartial<I extends Exact<DeepPartial<Packet_InitAck>, I>>(object: I): Packet_InitAck {
    const message = createBasePacket_InitAck();
    message.senderEphPub = object.senderEphPub ?? new Uint8Array();
...
export const Packet_Complete = {
  encode(message: Packet_Complete, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.ciphertext.length !== 0) {
  ...
  async *encodeTransform(
    source: AsyncIterable<Packet_Complete | Packet_Complete[]> | Iterable<Packet_Complete | Packet_Complete[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
  ...
  fromJSON(object: any): Packet_Complete {
    return { ciphertext: isSet(object.ciphertext) ? bytesFromBase64(object.ciphertext) : new Uint8Array() };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Packet_Complete>, I>>(object: I): Packet_Complete {
    const message = createBasePacket_Complete();
    message.ciphertext = object.ciphertext ?? new Uint8Array();
    return message;
  },
...
export const Packet_Ciphertext = {
  encode(message: Packet_Ciphertext, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  async *encodeTransform(
    source: AsyncIterable<Packet_Ciphertext | Packet_Ciphertext[]> | Iterable<Packet_Ciphertext | Packet_Ciphertext[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
  ...
  fromJSON(object: any): Packet_Ciphertext {
    return {
      tupleSignature: isSet(object.tupleSignature) ? bytesFromBase64(object.tupleSignature) : new Uint8Array(),
      senderPubKey: isSet(object.senderPubKey) ? bytesFromBase64(object.senderPubKey) : new Uint8Array(),
      receiverKeyKnown: isSet(object.receiverKeyKnown) ? Boolean(object.receiverKeyKnown) : false,
      extraInfo: isSet(object.extraInfo) ? bytesFromBase64(object.extraInfo) : new Uint8Array(),
    };
  },
  ...
  toJSON(message: Packet_Ciphertext): unknown {
    ...
    message.tupleSignature !== undefined &&
      (obj.tupleSignature = base64FromBytes(
        message.tupleSignature !== undefined ? message.tupleSignature : new Uint8Array(),
      ));
    ...
    message.receiverKeyKnown !== undefined && (obj.receiverKeyKnown = message.receiverKeyKnown);
    message.extraInfo !== undefined &&
      (obj.extraInfo = base64FromBytes(message.extraInfo !== undefined ? message.extraInfo : new Uint8Array()));
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<Packet_Ciphertext>, I>>(object: I): Packet_Ciphertext {
    const message = createBasePacket_Ciphertext();
