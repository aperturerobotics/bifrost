...
export const DialerOpts = {
  encode(message: DialerOpts, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.address !== "") {
  ...
  async *encodeTransform(
    source: AsyncIterable<DialerOpts | DialerOpts[]> | Iterable<DialerOpts | DialerOpts[]>,
  ...
  fromPartial<I extends Exact<DeepPartial<DialerOpts>, I>>(object: I): DialerOpts {
    const message = createBaseDialerOpts();
