...
import { BlockCrypt, blockCryptFromJSON, blockCryptToJSON } from "../../../util/blockcrypt/blockcrypt.pb.js";
...
function createBaseOpts(): Opts {
  return { dataShards: 0, parityShards: 0, mtu: 0, kcpMode: 0, blockCrypt: 0, blockCompress: 0, streamMuxer: 0 };
}
...
export const Opts = {
  ...
  fromJSON(object: any): Opts {
    return {
      ...
      parityShards: isSet(object.parityShards) ? Number(object.parityShards) : 0,
      mtu: isSet(object.mtu) ? Number(object.mtu) : 0,
      kcpMode: isSet(object.kcpMode) ? kCPModeFromJSON(object.kcpMode) : 0,
      blockCrypt: isSet(object.blockCrypt) ? blockCryptFromJSON(object.blockCrypt) : 0,
      blockCompress: isSet(object.blockCompress) ? blockCompressFromJSON(object.blockCompress) : 0,
      streamMuxer: isSet(object.streamMuxer) ? streamMuxerFromJSON(object.streamMuxer) : 0,
    };
  },

  toJSON(message: Opts): unknown {
    const obj: any = {};
    message.dataShards !== undefined && (obj.dataShards = Math.round(message.dataShards));
    message.parityShards !== undefined && (obj.parityShards = Math.round(message.parityShards));
    message.mtu !== undefined && (obj.mtu = Math.round(message.mtu));
    message.kcpMode !== undefined && (obj.kcpMode = kCPModeToJSON(message.kcpMode));
    message.blockCrypt !== undefined && (obj.blockCrypt = blockCryptToJSON(message.blockCrypt));
    message.blockCompress !== undefined && (obj.blockCompress = blockCompressToJSON(message.blockCompress));
    message.streamMuxer !== undefined && (obj.streamMuxer = streamMuxerToJSON(message.streamMuxer));
    return obj;
  },
