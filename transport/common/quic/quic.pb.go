...
func (m *Opts) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		if wireType == 4 {
			return errors.Errorf("proto: Opts: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return errors.Errorf("proto: Opts: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return errors.Errorf("proto: wrong wireType = %d for field MaxIdleTimeoutDur", wireType)
			}
		...
		case 2:
			if wireType != 0 {
				return errors.Errorf("proto: wrong wireType = %d for field MaxIncomingStreams", wireType)
			}
		...
		case 3:
			if wireType != 0 {
				return errors.Errorf("proto: wrong wireType = %d for field DisableKeepAlive", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 4:
			if wireType != 0 {
				return errors.Errorf("proto: wrong wireType = %d for field DisableDatagrams", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 5:
			if wireType != 0 {
				return errors.Errorf("proto: wrong wireType = %d for field DisablePathMtuDiscovery", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 7:
			if wireType != 2 {
				return errors.Errorf("proto: wrong wireType = %d for field KeepAliveDur", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
