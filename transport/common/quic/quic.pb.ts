...
export const Opts = {
  ...
  async *encodeTransform(source: AsyncIterable<Opts | Opts[]> | Iterable<Opts | Opts[]>): AsyncIterable<Uint8Array> {
  ...
  fromJSON(object: any): Opts {
    return {
      maxIdleTimeoutDur: isSet(object.maxIdleTimeoutDur) ? String(object.maxIdleTimeoutDur) : "",
      maxIncomingStreams: isSet(object.maxIncomingStreams) ? Number(object.maxIncomingStreams) : 0,
      disableKeepAlive: isSet(object.disableKeepAlive) ? Boolean(object.disableKeepAlive) : false,
      keepAliveDur: isSet(object.keepAliveDur) ? String(object.keepAliveDur) : "",
      disableDatagrams: isSet(object.disableDatagrams) ? Boolean(object.disableDatagrams) : false,
      disablePathMtuDiscovery: isSet(object.disablePathMtuDiscovery) ? Boolean(object.disablePathMtuDiscovery) : false,
  ...
  toJSON(message: Opts): unknown {
    const obj: any = {};
    message.maxIdleTimeoutDur !== undefined && (obj.maxIdleTimeoutDur = message.maxIdleTimeoutDur);
    message.maxIncomingStreams !== undefined && (obj.maxIncomingStreams = Math.round(message.maxIncomingStreams));
    message.disableKeepAlive !== undefined && (obj.disableKeepAlive = message.disableKeepAlive);
    message.keepAliveDur !== undefined && (obj.keepAliveDur = message.keepAliveDur);
    message.disableDatagrams !== undefined && (obj.disableDatagrams = message.disableDatagrams);
    message.disablePathMtuDiscovery !== undefined && (obj.disablePathMtuDiscovery = message.disablePathMtuDiscovery);
