...
export const Opts: MessageType<Opts> = createMessageType({
    ...
    fields: [
        { no: 1, name: "max_idle_timeout_dur", kind: "scalar", T: ScalarType.STRING },
        { no: 2, name: "max_incoming_streams", kind: "scalar", T: ScalarType.INT32 },
        ...
        { no: 5, name: "disable_path_mtu_discovery", kind: "scalar", T: ScalarType.BOOL },
