...
export const Opts = {
  ...
  toJSON(message: Opts): unknown {
    const obj: any = {};
    message.quic !== undefined && (obj.quic = message.quic ? Opts1.toJSON(message.quic) : undefined);
  ...
  fromPartial<I extends Exact<DeepPartial<Opts>, I>>(object: I): Opts {
    const message = createBaseOpts();
    message.quic = (object.quic !== undefined && object.quic !== null) ? Opts1.fromPartial(object.quic) : undefined;
