...
function createBaseConfig(): Config {
  return { transportPeerId: "", devicePath: "", deviceBaud: 0, packetOpts: undefined, dialers: {} };
}
...
export const Config = {
  encode(message: Config, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    Object.entries(message.dialers).forEach(([key, value]) => {
      Config_DialersEntry.encode({ key: key as any, value }, writer.uint32(42).fork()).ldelim();
    });
    return writer;
  },
  ...
  fromJSON(object: any): Config {
    return {
      transportPeerId: isSet(object.transportPeerId) ? String(object.transportPeerId) : "",
      devicePath: isSet(object.devicePath) ? String(object.devicePath) : "",
      deviceBaud: isSet(object.deviceBaud) ? Number(object.deviceBaud) : 0,
      packetOpts: isSet(object.packetOpts) ? Opts.fromJSON(object.packetOpts) : undefined,
      dialers: isObject(object.dialers)
        ? Object.entries(object.dialers).reduce<{ [key: string]: DialerOpts }>((acc, [key, value]) => {
  ...
  toJSON(message: Config): unknown {
    const obj: any = {};
    message.transportPeerId !== undefined && (obj.transportPeerId = message.transportPeerId);
    message.devicePath !== undefined && (obj.devicePath = message.devicePath);
    message.deviceBaud !== undefined && (obj.deviceBaud = Math.round(message.deviceBaud));
    message.packetOpts !== undefined &&
      (obj.packetOpts = message.packetOpts ? Opts.toJSON(message.packetOpts) : undefined);
    obj.dialers = {};
    if (message.dialers) {
  ...
  fromPartial<I extends Exact<DeepPartial<Config>, I>>(object: I): Config {
    ...
    message.packetOpts = (object.packetOpts !== undefined && object.packetOpts !== null)
      ? Opts.fromPartial(object.packetOpts)
      : undefined;
    message.dialers = Object.entries(object.dialers ?? {}).reduce<{ [key: string]: DialerOpts }>(
      (acc, [key, value]) => {
        if (value !== undefined) {
...
export const Config_DialersEntry = {
  encode(message: Config_DialersEntry, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.key !== "") {
  ...
  fromJSON(object: any): Config_DialersEntry {
    return {
      ...
      value: isSet(object.value) ? DialerOpts.fromJSON(object.value) : undefined,
    };
  },
  ...
  toJSON(message: Config_DialersEntry): unknown {
    ...
    message.value !== undefined && (obj.value = message.value ? DialerOpts.toJSON(message.value) : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<Config_DialersEntry>, I>>(object: I): Config_DialersEntry {
    const message = createBaseConfig_DialersEntry();
