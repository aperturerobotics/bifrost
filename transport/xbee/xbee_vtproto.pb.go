...
func (m *Config) CloneVT() *Config {
	...
	r.DevicePath = m.DevicePath
	r.DeviceBaud = m.DeviceBaud
...
func (m *Config) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.DeviceBaud != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.DeviceBaud))
		i--
		dAtA[i] = 0x18
	}
...
func (m *Config) SizeVT() (n int) {
	...
	if m.DeviceBaud != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.DeviceBaud))
	}
	if m.PacketOpts != nil {
