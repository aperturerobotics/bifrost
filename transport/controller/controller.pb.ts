...
export const StreamEstablish = {
  encode(message: StreamEstablish, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  async *encodeTransform(
    source: AsyncIterable<StreamEstablish | StreamEstablish[]> | Iterable<StreamEstablish | StreamEstablish[]>,
  ...
  fromJSON(object: any): StreamEstablish {
    return { protocolId: isSet(object.protocolId) ? String(object.protocolId) : "" };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<StreamEstablish>, I>>(object: I): StreamEstablish {
    const message = createBaseStreamEstablish();
