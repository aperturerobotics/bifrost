...
func (m *Config) CloneVT() *Config {
	...
	r := &Config{
		SignalingId:     m.SignalingId,
		TransportPeerId: m.TransportPeerId,
		TransportType:   m.TransportType,
		WebRtc:          m.WebRtc.CloneVT(),
		AllPeers:        m.AllPeers,
		DisableListen:   m.DisableListen,
		Verbose:         m.Verbose,
	}
...
func (m *WebRtcConfig) CloneVT() *WebRtcConfig {
	...
	r := &WebRtcConfig{
		...
		IceCandidatePoolSize: m.IceCandidatePoolSize,
	}
...
func (m *IceServerConfig_OauthCredential) CloneVT() *IceServerConfig_OauthCredential {
	...
	r := &IceServerConfig_OauthCredential{
		MacKey:      m.MacKey,
...
func (m *IceServerConfig_Oauth) CloneVT() isIceServerConfig_Credential {
	...
	r := &IceServerConfig_Oauth{
		Oauth: m.Oauth.CloneVT(),
	}
	return r
}
...
func (m *WebRtcSignal_RequestOffer) CloneVT() isWebRtcSignal_Body {
	...
	r := &WebRtcSignal_RequestOffer{
		RequestOffer: m.RequestOffer,
	}
	return r
}
...
func (m *Config) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.BlockPeers) > 0 {
		for iNdEx := len(m.BlockPeers) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarint(dAtA, i, uint64(len(m.BlockPeers[iNdEx])))
			i--
			dAtA[i] = 0x52
		}
	}
	...
	if len(m.TransportType) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.TransportType)))
		i--
		dAtA[i] = 0x1a
	}
	...
	if len(m.SignalingId) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.SignalingId)))
		i--
		dAtA[i] = 0xa
	}
...
func (m *WebRtcConfig) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.IceCandidatePoolSize != 0 {
		i = encodeVarint(dAtA, i, uint64(m.IceCandidatePoolSize))
		i--
		dAtA[i] = 0x18
	}
	if m.IceTransportPolicy != 0 {
		i = encodeVarint(dAtA, i, uint64(m.IceTransportPolicy))
		i--
		dAtA[i] = 0x10
	}
...
func (m *IceServerConfig_OauthCredential) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.MacKey) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.MacKey)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *WebRtcSignal_RequestOffer) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	i := len(dAtA)
	i = encodeVarint(dAtA, i, uint64(m.RequestOffer))
	i--
	dAtA[i] = 0x8
	return len(dAtA) - i, nil
}
...
func (m *WebRtcSdp) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.SdpType) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.SdpType)))
		i--
		dAtA[i] = 0x12
	}
	if m.TxSeqno != 0 {
		i = encodeVarint(dAtA, i, uint64(m.TxSeqno))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *WebRtcConfig) SizeVT() (n int) {
	...
	if m.IceTransportPolicy != 0 {
		n += 1 + sov(uint64(m.IceTransportPolicy))
	}
	if m.IceCandidatePoolSize != 0 {
		n += 1 + sov(uint64(m.IceCandidatePoolSize))
	}
	n += len(m.unknownFields)
	return n
}
