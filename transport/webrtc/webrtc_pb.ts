...
export interface IceServerConfig_OauthCredential
  extends Message<IceServerConfig_OauthCredential> {
  /**
 ...
 */
export interface IceServerConfig extends Message<IceServerConfig> {
  /**
 ...
 */
export interface WebRtcConfig extends Message<WebRtcConfig> {
  /**
 ...
 */
export interface WebRtcSdp extends Message<WebRtcSdp> {
  /**
 ...
 */
export interface WebRtcIce extends Message<WebRtcIce> {
  /**
 ...
 */
export interface WebRtcSignal extends Message<WebRtcSignal> {
  /**
