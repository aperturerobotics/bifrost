...
export const IceTransportPolicy_Enum = createEnumType("webrtc.IceTransportPolicy", [
...
export const IceServerConfig_OauthCredential: MessageType<IceServerConfig_OauthCredential> = createMessageType(
  {
...
export const IceServerConfig: MessageType<IceServerConfig> = createMessageType(
  {
    ...
    fields: [
        ...
        { no: 3, name: "password", kind: "scalar", T: 9 /* ScalarType.STRING */, oneof: "credential" },
        { no: 4, name: "oauth", kind: "message", T: () => IceServerConfig_OauthCredential, oneof: "credential" },
    ] as readonly PartialFieldInfo[],
    packedByDefault: true,
  },
);
...
export const WebRtcConfig: MessageType<WebRtcConfig> = createMessageType(
  {
    ...
    fields: [
        { no: 1, name: "ice_servers", kind: "message", T: () => IceServerConfig, repeated: true },
        { no: 2, name: "ice_transport_policy", kind: "enum", T: IceTransportPolicy_Enum },
        { no: 3, name: "ice_candidate_pool_size", kind: "scalar", T: 13 /* ScalarType.UINT32 */ },
    ] as readonly PartialFieldInfo[],
    packedByDefault: true,
  },
);
...
export const Config: MessageType<Config> = createMessageType(
  {
    ...
    fields: [
        ...
        { no: 2, name: "transport_peer_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
        { no: 3, name: "transport_type", kind: "scalar", T: 9 /* ScalarType.STRING */ },
        { no: 4, name: "quic", kind: "message", T: () => Opts },
        { no: 5, name: "web_rtc", kind: "message", T: () => WebRtcConfig },
        { no: 6, name: "backoff", kind: "message", T: () => Backoff },
        { no: 7, name: "dialers", kind: "map", K: 9 /* ScalarType.STRING */, V: {kind: "message", T: () => DialerOpts} },
        { no: 8, name: "all_peers", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
        { no: 9, name: "disable_listen", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
        { no: 10, name: "block_peers", kind: "scalar", T: 9 /* ScalarType.STRING */, repeated: true },
...
export const WebRtcSignal: MessageType<WebRtcSignal> = createMessageType(
  {
    ...
    fields: [
        { no: 1, name: "request_offer", kind: "scalar", T: 4 /* ScalarType.UINT64 */, oneof: "body" },
