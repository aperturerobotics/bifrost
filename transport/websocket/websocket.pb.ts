...
function createBaseConfig(): Config {
  return { transportPeerId: "", listenAddr: "", quic: undefined, dialers: {}, restrictPeerId: "" };
}
...
export const Config = {
  encode(message: Config, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    Object.entries(message.dialers).forEach(([key, value]) => {
      Config_DialersEntry.encode({ key: key as any, value }, writer.uint32(34).fork()).ldelim();
    });
  ...
  fromJSON(object: any): Config {
    return {
      ...
      dialers: isObject(object.dialers)
        ...
        : {},
      restrictPeerId: isSet(object.restrictPeerId) ? String(object.restrictPeerId) : "",
    };
  },
  ...
  toJSON(message: Config): unknown {
    ...
    message.quic !== undefined && (obj.quic = message.quic ? Opts.toJSON(message.quic) : undefined);
    obj.dialers = {};
    if (message.dialers) {
    ...
    message.restrictPeerId !== undefined && (obj.restrictPeerId = message.restrictPeerId);
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Config>, I>>(object: I): Config {
    ...
    message.quic = (object.quic !== undefined && object.quic !== null) ? Opts.fromPartial(object.quic) : undefined;
