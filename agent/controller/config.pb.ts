...
export const protobufPackage = 'agent.controller'
...
export const Config = {
  encode(
    ...
    if (message.nodePeerId !== '') {
      writer.uint32(18).string(message.nodePeerId)
    }
    return writer
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          message.nodePeerId = reader.string()
          continue
      }
      if ((tag & 7) == 4 || tag == 0) {
        break
  ...
  toJSON(message: Config): unknown {
    ...
    message.nodePeerId !== undefined && (obj.nodePeerId = message.nodePeerId)
    return obj
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Config>, I>>(object: I): Config {
    ...
    message.nodePeerId = object.nodePeerId ?? ''
    return message
  },
}
