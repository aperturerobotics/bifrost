...
// Controller implements the grpcaccept controller. The controller accepts
// HandleMountedStream via waiting GRPC RPC calls and streams data over the
...
func (c *Controller) GetControllerInfo() controller.Info {
	return controller.NewInfo(
		ControllerID,
		Version,
		"grpcaccept controller",
	)
}

// Execute executes the grpcaccept controller.
