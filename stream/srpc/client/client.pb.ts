...
export const Config: MessageType<Config> = createMessageType(
  {
    ...
    fields: [
        { no: 1, name: "server_peer_ids", kind: "scalar", T: 9 /* ScalarType.STRING */, repeated: true },
        { no: 2, name: "per_server_backoff", kind: "message", T: () => Backoff },
        { no: 3, name: "src_peer_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
        { no: 4, name: "transport_id", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
        { no: 5, name: "timeout_dur", kind: "scalar", T: 9 /* ScalarType.STRING */ },
