...
export const Config = {
  ...
  fromJSON(object: any): Config {
    return {
      peerIds: Array.isArray(object?.peerIds) ? object.peerIds.map((e: any) => String(e)) : [],
      drpcOpts: isSet(object.drpcOpts) ? DrpcOpts.fromJSON(object.drpcOpts) : undefined,
    };
  },
  ...
  toJSON(message: Config): unknown {
    ...
    message.drpcOpts !== undefined && (obj.drpcOpts = message.drpcOpts ? DrpcOpts.toJSON(message.drpcOpts) : undefined);
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Config>, I>>(object: I): Config {
    ...
    message.drpcOpts = (object.drpcOpts !== undefined && object.drpcOpts !== null)
