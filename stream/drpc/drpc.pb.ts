...
export const DrpcOpts = {
  encode(message: DrpcOpts, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  async *encodeTransform(
    source: AsyncIterable<DrpcOpts | DrpcOpts[]> | Iterable<DrpcOpts | DrpcOpts[]>,
  ...
  fromJSON(object: any): DrpcOpts {
    return { managerOpts: isSet(object.managerOpts) ? ManagerOpts.fromJSON(object.managerOpts) : undefined };
  },

  toJSON(message: DrpcOpts): unknown {
    const obj: any = {};
    message.managerOpts !== undefined &&
      (obj.managerOpts = message.managerOpts ? ManagerOpts.toJSON(message.managerOpts) : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<DrpcOpts>, I>>(object: I): DrpcOpts {
    const message = createBaseDrpcOpts();
    message.managerOpts = (object.managerOpts !== undefined && object.managerOpts !== null)
...
export const ManagerOpts = {
  encode(message: ManagerOpts, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  async *encodeTransform(
    source: AsyncIterable<ManagerOpts | ManagerOpts[]> | Iterable<ManagerOpts | ManagerOpts[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
  ...
  fromJSON(object: any): ManagerOpts {
    return {
      writerBufferSize: isSet(object.writerBufferSize) ? Number(object.writerBufferSize) : 0,
      streamOpts: isSet(object.streamOpts) ? StreamOpts.fromJSON(object.streamOpts) : undefined,
      inactivityTimeout: isSet(object.inactivityTimeout) ? String(object.inactivityTimeout) : "",
    };
  },

  toJSON(message: ManagerOpts): unknown {
    const obj: any = {};
    message.writerBufferSize !== undefined && (obj.writerBufferSize = Math.round(message.writerBufferSize));
    message.streamOpts !== undefined &&
      (obj.streamOpts = message.streamOpts ? StreamOpts.toJSON(message.streamOpts) : undefined);
    message.inactivityTimeout !== undefined && (obj.inactivityTimeout = message.inactivityTimeout);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<ManagerOpts>, I>>(object: I): ManagerOpts {
    const message = createBaseManagerOpts();
    message.writerBufferSize = object.writerBufferSize ?? 0;
    message.streamOpts = (object.streamOpts !== undefined && object.streamOpts !== null)
...
export const StreamOpts = {
  encode(message: StreamOpts, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  async *encodeTransform(
    source: AsyncIterable<StreamOpts | StreamOpts[]> | Iterable<StreamOpts | StreamOpts[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
  ...
  toJSON(message: StreamOpts): unknown {
    const obj: any = {};
    message.splitSize !== undefined && (obj.splitSize = Math.round(message.splitSize));
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<StreamOpts>, I>>(object: I): StreamOpts {
    const message = createBaseStreamOpts();
