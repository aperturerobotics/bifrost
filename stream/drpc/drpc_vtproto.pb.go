...
func (m *ManagerOpts) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.InactivityTimeout) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.InactivityTimeout)))
		i--
		dAtA[i] = 0x1a
	}
	if m.StreamOpts != nil {
	...
	if m.WriterBufferSize != 0 {
		i = encodeVarint(dAtA, i, uint64(m.WriterBufferSize))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *StreamOpts) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.SplitSize != 0 {
		i = encodeVarint(dAtA, i, uint64(m.SplitSize))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *ManagerOpts) SizeVT() (n int) {
	...
	_ = l
	if m.WriterBufferSize != 0 {
		n += 1 + sov(uint64(m.WriterBufferSize))
	}
	if m.StreamOpts != nil {
