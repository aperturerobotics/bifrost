...
function createBaseConfig(): Config {
  return { localPeerId: "", remotePeerIds: [], protocolId: "", transportId: Long.UZERO };
}
...
export const Config = {
  ...
  fromJSON(object: any): Config {
    return {
      ...
      remotePeerIds: Array.isArray(object?.remotePeerIds) ? object.remotePeerIds.map((e: any) => String(e)) : [],
