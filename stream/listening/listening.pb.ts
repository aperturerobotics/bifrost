...
export const Config = {
  ...
  fromJSON(object: any): Config {
    return {
      ...
      remotePeerId: isSet(object.remotePeerId) ? String(object.remotePeerId) : "",
      protocolId: isSet(object.protocolId) ? String(object.protocolId) : "",
      listenMultiaddr: isSet(object.listenMultiaddr) ? String(object.listenMultiaddr) : "",
  ...
  toJSON(message: Config): unknown {
    ...
    message.remotePeerId !== undefined && (obj.remotePeerId = message.remotePeerId);
    message.protocolId !== undefined && (obj.protocolId = message.protocolId);
    message.listenMultiaddr !== undefined && (obj.listenMultiaddr = message.listenMultiaddr);
