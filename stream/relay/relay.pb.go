...
func (m *Config) CloneVT() *Config {
	...
	r.TargetProtocolId = m.TargetProtocolId
...
func (this *Config) EqualVT(that *Config) bool {
	...
	if this.TargetProtocolId != that.TargetProtocolId {
		return false
	}
...
func (x *Config) MarshalProtoJSON(s *json.MarshalState) {
	...
	if x.TargetProtocolId != "" || s.HasField("targetProtocolId") {
		s.WriteMoreIf(&wroteField)
		s.WriteObjectField("targetProtocolId")
		s.WriteString(x.TargetProtocolId)
	}
	s.WriteObjectEnd()
}
...
func (x *Config) UnmarshalProtoJSON(s *json.UnmarshalState) {
	...
	s.ReadObject(func(key string) {
		...
		case "target_protocol_id", "targetProtocolId":
			s.AddField("target_protocol_id")
			x.TargetProtocolId = s.ReadString()
		}
	})
}
...
func (m *Config) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.TargetProtocolId) > 0 {
		i -= len(m.TargetProtocolId)
		copy(dAtA[i:], m.TargetProtocolId)
		i = protobuf_go_lite.EncodeVarint(dAtA, i, uint64(len(m.TargetProtocolId)))
		i--
		dAtA[i] = 0x22
	}
...
func (x *Config) MarshalProtoText() string {
	...
	if x.TargetProtocolId != "" {
		if sb.Len() > 8 {
			sb.WriteString(" ")
		}
		sb.WriteString("target_protocol_id: ")
		sb.WriteString(strconv.Quote(x.TargetProtocolId))
	}
	sb.WriteString("}")
	return sb.String()
}
...
func (m *Config) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TargetProtocolId", wireType)
			}
			var stringLen uint64
			stringLen, iNdEx, err = protobuf_go_lite.DecodeVarint(dAtA, iNdEx)
			if err != nil {
			...
			m.TargetProtocolId = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
