...
function createBaseConfig(): Config {
  return { peerId: "", protocolId: "", targetMultiaddr: "" };
}
...
export const Config = {
  encode(message: Config, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.targetMultiaddr !== "") {
      writer.uint32(26).string(message.targetMultiaddr);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          message.targetMultiaddr = reader.string();
          break;
        default:
  ...
  fromJSON(object: any): Config {
    return {
      ...
      targetMultiaddr: isSet(object.targetMultiaddr) ? String(object.targetMultiaddr) : "",
    };
  },
  ...
  toJSON(message: Config): unknown {
    ...
    message.targetMultiaddr !== undefined && (obj.targetMultiaddr = message.targetMultiaddr);
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Config>, I>>(object: I): Config {
    ...
    message.targetMultiaddr = object.targetMultiaddr ?? "";
    return message;
  },
};
