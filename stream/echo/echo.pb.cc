...
static constexpr const ::_pb::EnumDescriptor* PROTOBUF_NONNULL* PROTOBUF_NULLABLE
    file_level_enum_descriptors_github_2ecom_2faperturerobotics_2fbifrost_2fstream_2fecho_2fecho_2eproto = nullptr;
static constexpr const ::_pb::ServiceDescriptor* PROTOBUF_NONNULL* PROTOBUF_NULLABLE
    file_level_service_descriptors_github_2ecom_2faperturerobotics_2fbifrost_2fstream_2fecho_2fecho_2eproto = nullptr;
const ::uint32_t
    TableStruct_github_2ecom_2faperturerobotics_2fbifrost_2fstream_2fecho_2fecho_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
        0x081, // bitmap
        PROTOBUF_FIELD_OFFSET(::stream::echo::Config, _impl_._has_bits_),
        5, // hasbit index offset
        PROTOBUF_FIELD_OFFSET(::stream::echo::Config, _impl_.peer_id_),
        PROTOBUF_FIELD_OFFSET(::stream::echo::Config, _impl_.protocol_id_),
        0,
        1,
};
...
static const ::_pbi::MigrationSchema
    schemas[] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        {0, sizeof(::stream::echo::Config)},
};
static const ::_pb::Message* PROTOBUF_NONNULL const file_default_instances[] = {
    &::stream::echo::_Config_default_instance_._instance,
};
const char descriptor_table_protodef_github_2ecom_2faperturerobotics_2fbifrost_2fstream_2fecho_2fecho_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
    "\n:github.com/aperturerobotics/bifrost/st"
    "ream/echo/echo.proto\022\013stream.echo\".\n\006Con"
    "fig\022\017\n\007peer_id\030\001 \001(\t\022\023\n\013protocol_id\030\002 \001("
    "\tb\006proto3"
};
static ::absl::once_flag descriptor_table_github_2ecom_2faperturerobotics_2fbifrost_2fstream_2fecho_2fecho_2eproto_once;
PROTOBUF_CONSTINIT const ::_pbi::DescriptorTable descriptor_table_github_2ecom_2faperturerobotics_2fbifrost_2fstream_2fecho_2fecho_2eproto = {
    false,
    false,
    129,
    descriptor_table_protodef_github_2ecom_2faperturerobotics_2fbifrost_2fstream_2fecho_2fecho_2eproto,
    "github.com/aperturerobotics/bifrost/stream/echo/echo.proto",
    &descriptor_table_github_2ecom_2faperturerobotics_2fbifrost_2fstream_2fecho_2fecho_2eproto_once,
    nullptr,
    0,
    1,
    schemas,
    file_default_instances,
    TableStruct_github_2ecom_2faperturerobotics_2fbifrost_2fstream_2fecho_2fecho_2eproto::offsets,
    file_level_enum_descriptors_github_2ecom_2faperturerobotics_2fbifrost_2fstream_2fecho_2fecho_2eproto,
    file_level_service_descriptors_github_2ecom_2faperturerobotics_2fbifrost_2fstream_2fecho_2fecho_2eproto,
};
namespace stream {
namespace echo {
// ===================================================================
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:stream.echo.Config)
}
PROTOBUF_NDEBUG_INLINE Config::Impl_::Impl_(
    [[maybe_unused]] ::google::protobuf::internal::InternalVisibility visibility,
    [[maybe_unused]] ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    [[maybe_unused]] const ::stream::echo::Config& from_msg)
...
Config::Config(
  ...
  // @@protoc_insertion_point(copy_constructor:stream.echo.Config)
}
PROTOBUF_NDEBUG_INLINE Config::Impl_::Impl_(
    [[maybe_unused]] ::google::protobuf::internal::InternalVisibility visibility,
...
Config::~Config() {
  // @@protoc_insertion_point(destructor:stream.echo.Config)
  SharedDtor(*this);
}
...
constexpr auto Config::InternalGenerateClassData_() {
  return ::google::protobuf::internal::ClassDataFull{
      ...
      &descriptor_table_github_2ecom_2faperturerobotics_2fbifrost_2fstream_2fecho_2fecho_2eproto,
      nullptr,  // tracker
  };
}
...
Config::_table_ = {
  {
    ...
    ::_pbi::TcParser::GetTable<::stream::echo::Config>(),  // to_prefetch
...
// @@protoc_insertion_point(message_clear_start:stream.echo.Config)
...
::uint8_t* PROTOBUF_NONNULL Config::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:stream.echo.Config)
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
  ...
  if (CheckHasBit(cached_has_bits, 0x00000001U)) {
    if (!this_._internal_peer_id().empty()) {
      ...
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "stream.echo.Config.peer_id");
  ...
  if (CheckHasBit(cached_has_bits, 0x00000002U)) {
    if (!this_._internal_protocol_id().empty()) {
      ...
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "stream.echo.Config.protocol_id");
  ...
  // @@protoc_insertion_point(serialize_to_array_end:stream.echo.Config)
  return target;
}
...
::size_t Config::ByteSizeLong() const {
  const Config& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
  // @@protoc_insertion_point(message_byte_size_start:stream.echo.Config)
  ::size_t total_size = 0;
...
void Config::MergeImpl(::google::protobuf::MessageLite& to_msg,
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:stream.echo.Config)
...
void Config::CopyFrom(const Config& from) {
  // @@protoc_insertion_point(class_specific_copy_from_start:stream.echo.Config)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::std::false_type
    _static_init2_ [[maybe_unused]] =
        (::_pbi::AddDescriptors(&descriptor_table_github_2ecom_2faperturerobotics_2fbifrost_2fstream_2fecho_2fecho_2eproto),
         ::std::false_type{});
