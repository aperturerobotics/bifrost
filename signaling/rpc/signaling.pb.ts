...
export const ListenResponse: MessageType<ListenResponse> = createMessageType(
  {
    ...
    fields: [
        { no: 1, name: "set_peer", kind: "scalar", T: 9 /* ScalarType.STRING */, oneof: "body" },
        { no: 2, name: "clear_peer", kind: "scalar", T: 9 /* ScalarType.STRING */, oneof: "body" },
    ] as readonly PartialFieldInfo[],
    packedByDefault: true,
  },
);
...
export const SessionRequest: MessageType<SessionRequest> = createMessageType(
  {
    ...
    fields: [
        { no: 1, name: "session_seqno", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
        { no: 2, name: "init", kind: "message", T: () => SessionInit, oneof: "body" },
        { no: 3, name: "send_msg", kind: "message", T: () => SessionMsg, oneof: "body" },
        { no: 4, name: "clear_msg", kind: "scalar", T: 4 /* ScalarType.UINT64 */, oneof: "body" },
        { no: 5, name: "ack_msg", kind: "scalar", T: 4 /* ScalarType.UINT64 */, oneof: "body" },
    ] as readonly PartialFieldInfo[],
    packedByDefault: true,
  },
);
...
export const SessionResponse: MessageType<SessionResponse> = createMessageType(
  {
    ...
    fields: [
        { no: 1, name: "opened", kind: "scalar", T: 4 /* ScalarType.UINT64 */, oneof: "body" },
        { no: 2, name: "closed", kind: "scalar", T: 8 /* ScalarType.BOOL */, oneof: "body" },
