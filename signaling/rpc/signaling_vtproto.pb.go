...
func (m *ListenResponse_SetPeer) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.SetPeer)))
	i--
	dAtA[i] = 0xa
	return len(dAtA) - i, nil
}
...
func (m *ListenResponse_ClearPeer) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.ClearPeer)))
	i--
	dAtA[i] = 0x12
	return len(dAtA) - i, nil
}
...
func (m *SessionRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.SessionSeqno != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.SessionSeqno))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *SessionRequest_ClearMsg) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	i := len(dAtA)
	i = protohelpers.EncodeVarint(dAtA, i, uint64(m.ClearMsg))
	i--
	dAtA[i] = 0x20
	return len(dAtA) - i, nil
}
...
func (m *SessionRequest_AckMsg) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	i := len(dAtA)
	i = protohelpers.EncodeVarint(dAtA, i, uint64(m.AckMsg))
	i--
	dAtA[i] = 0x28
	return len(dAtA) - i, nil
}
...
func (m *SessionResponse_Opened) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	i := len(dAtA)
	i = protohelpers.EncodeVarint(dAtA, i, uint64(m.Opened))
	i--
	dAtA[i] = 0x8
	return len(dAtA) - i, nil
}
...
func (m *SessionRequest) SizeVT() (n int) {
	...
	_ = l
	if m.SessionSeqno != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.SessionSeqno))
	}
	if vtmsg, ok := m.Body.(interface{ SizeVT() int }); ok {
		n += vtmsg.SizeVT()
	}
...
func (m *SessionRequest_ClearMsg) SizeVT() (n int) {
	...
	var l int
	_ = l
	n += 1 + protohelpers.SizeOfVarint(uint64(m.ClearMsg))
	return n
}
func (m *SessionRequest_AckMsg) SizeVT() (n int) {
	...
	var l int
	_ = l
	n += 1 + protohelpers.SizeOfVarint(uint64(m.AckMsg))
	return n
}
...
func (m *SessionResponse_Opened) SizeVT() (n int) {
	...
	var l int
	_ = l
	n += 1 + protohelpers.SizeOfVarint(uint64(m.Opened))
	return n
}
