...
function createBaseConfig(): Config {
  return { listenAddr: "", apiConfig: undefined, disableBusApi: false, busApiConfig: undefined };
}
...
export const Config = {
  ...
  fromJSON(object: any): Config {
    return {
      ...
      apiConfig: isSet(object.apiConfig) ? Config1.fromJSON(object.apiConfig) : undefined,
  ...
  toJSON(message: Config): unknown {
    ...
    message.apiConfig !== undefined &&
      (obj.apiConfig = message.apiConfig ? Config1.toJSON(message.apiConfig) : undefined);
