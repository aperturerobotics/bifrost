...
import grpcaccept "github.com/aperturerobotics/bifrost/stream/grpcaccept"
...
func (ControllerStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_api_4fad05deb60951b3, []int{0}
}
...
func (*GetPeerInfoRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_4fad05deb60951b3, []int{1}
}
...
func (*PeerInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_4fad05deb60951b3, []int{2}
}
...
func (*GetPeerInfoResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_4fad05deb60951b3, []int{3}
}
...
func (*GetBusInfoRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_4fad05deb60951b3, []int{4}
}
...
func (*DebugValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_4fad05deb60951b3, []int{5}
}
...
func (*DirectiveInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_4fad05deb60951b3, []int{6}
}
...
func (*GetBusInfoResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_4fad05deb60951b3, []int{7}
}
...
func (*ForwardStreamsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_4fad05deb60951b3, []int{8}
}
...
func (*ForwardStreamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_4fad05deb60951b3, []int{9}
}
...
func (*ListenStreamsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_4fad05deb60951b3, []int{10}
}
...
func (*ListenStreamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_4fad05deb60951b3, []int{11}
}
...
type AcceptStreamRequest struct {
	...
	Config *grpcaccept.Config `protobuf:"bytes,1,opt,name=config" json:"config,omitempty"`
	// Request is a request packet.
	Request              *grpcaccept.Request `protobuf:"bytes,2,opt,name=request" json:"request,omitempty"`
	XXX_NoUnkeyedLiteral struct{}            `json:"-"`
	XXX_unrecognized     []byte              `json:"-"`
	XXX_sizecache        int32               `json:"-"`
}
...
func (*AcceptStreamRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_4fad05deb60951b3, []int{12}
}
...
func (m *AcceptStreamRequest) GetConfig() *grpcaccept.Config {
	if m != nil {
		return m.Config
	}
	return nil
...
func (m *AcceptStreamRequest) GetRequest() *grpcaccept.Request {
	if m != nil {
		return m.Request
	}
	return nil
...
type AcceptStreamResponse struct {
	...
	Response             *grpcaccept.Response `protobuf:"bytes,1,opt,name=response" json:"response,omitempty"`
	XXX_NoUnkeyedLiteral struct{}             `json:"-"`
	XXX_unrecognized     []byte               `json:"-"`
	XXX_sizecache        int32                `json:"-"`
}
...
func (*AcceptStreamResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_4fad05deb60951b3, []int{13}
}
...
func (m *AcceptStreamResponse) GetResponse() *grpcaccept.Response {
	if m != nil {
		return m.Response
	}
	return nil
...
func init() {
	proto.RegisterFile("github.com/aperturerobotics/bifrost/daemon/api/api.proto", fileDescriptor_api_4fad05deb60951b3)
}

var fileDescriptor_api_4fad05deb60951b3 = []byte{
	// 751 bytes of a gzipped FileDescriptorProto
	,
}
