...
func (*Config) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_6438da70ecc880fd, []int{0}
}
...
func init() {
	proto.RegisterFile("github.com/aperturerobotics/bifrost/peer/controller/config.proto", fileDescriptor_config_6438da70ecc880fd)
}

var fileDescriptor_config_6438da70ecc880fd = []byte{
