...
type drpcEncoding_File_github_com_aperturerobotics_bifrost_peer_grpc_grpc_proto struct{}

func (drpcEncoding_File_github_com_aperturerobotics_bifrost_peer_grpc_grpc_proto) Marshal(msg drpc.Message) ([]byte, error) {
	return proto.Marshal(msg)
}

func (drpcEncoding_File_github_com_aperturerobotics_bifrost_peer_grpc_grpc_proto) Unmarshal(buf []byte, msg drpc.Message) error {
...
func (c *drpcPeerServiceClient) Identify(ctx context.Context, in *IdentifyRequest) (DRPCPeerService_IdentifyClient, error) {
	stream, err := c.cc.NewStream(ctx, "/peer.grpc.PeerService/Identify", drpcEncoding_File_github_com_aperturerobotics_bifrost_peer_grpc_grpc_proto{})
	if err != nil {
		return nil, err
	}
	x := &drpcPeerService_IdentifyClient{stream}
	if err := x.MsgSend(in, drpcEncoding_File_github_com_aperturerobotics_bifrost_peer_grpc_grpc_proto{}); err != nil {
		return nil, err
	}
...
func (x *drpcPeerService_IdentifyClient) Recv() (*IdentifyResponse, error) {
	...
	if err := x.MsgRecv(m, drpcEncoding_File_github_com_aperturerobotics_bifrost_peer_grpc_grpc_proto{}); err != nil {
		return nil, err
	}
	return m, nil
}
...
func (x *drpcPeerService_IdentifyClient) RecvMsg(m *IdentifyResponse) error {
	return x.MsgRecv(m, drpcEncoding_File_github_com_aperturerobotics_bifrost_peer_grpc_grpc_proto{})
}
...
func (c *drpcPeerServiceClient) GetPeerInfo(ctx context.Context, in *GetPeerInfoRequest) (*GetPeerInfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/peer.grpc.PeerService/GetPeerInfo", drpcEncoding_File_github_com_aperturerobotics_bifrost_peer_grpc_grpc_proto{}, in, out)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (DRPCPeerServiceDescription) Method(n int) (string, drpc.Encoding, drpc.Receiver, interface{}, bool) {
	switch n {
	case 0:
		return "/peer.grpc.PeerService/Identify", drpcEncoding_File_github_com_aperturerobotics_bifrost_peer_grpc_grpc_proto{},
	...
	case 1:
		return "/peer.grpc.PeerService/GetPeerInfo", drpcEncoding_File_github_com_aperturerobotics_bifrost_peer_grpc_grpc_proto{},
			func(srv interface{}, ctx context.Context, in1, in2 interface{}) (drpc.Message, error) {
...
func (x *drpcPeerService_IdentifyStream) Send(m *IdentifyResponse) error {
	return x.MsgSend(m, drpcEncoding_File_github_com_aperturerobotics_bifrost_peer_grpc_grpc_proto{})
}
...
func (x *drpcPeerService_GetPeerInfoStream) SendAndClose(m *GetPeerInfoResponse) error {
	if err := x.MsgSend(m, drpcEncoding_File_github_com_aperturerobotics_bifrost_peer_grpc_grpc_proto{}); err != nil {
		return err
	}
	return x.CloseSend()
}
