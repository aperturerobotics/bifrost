...
import fmt "fmt"
import math "math"
import controller "github.com/aperturerobotics/bifrost/peer/controller"
...
type IdentifyRequest struct {
	...
	Config               *controller.Config `protobuf:"bytes,1,opt,name=config" json:"config,omitempty"`
...
func (*IdentifyRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpc_c05c4816a80f1e74, []int{0}
}
...
func (*IdentifyResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpc_c05c4816a80f1e74, []int{1}
}
...
func (*GetPeerInfoRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpc_c05c4816a80f1e74, []int{2}
}
...
func (*PeerInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpc_c05c4816a80f1e74, []int{3}
}
...
func (*GetPeerInfoResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpc_c05c4816a80f1e74, []int{4}
}
...
func (c *peerServiceClient) Identify(ctx context.Context, in *IdentifyRequest, opts ...grpc.CallOption) (PeerService_IdentifyClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_PeerService_serviceDesc.Streams[0], c.cc, "/peer.grpc.PeerService/Identify", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *peerServiceClient) GetPeerInfo(ctx context.Context, in *GetPeerInfoRequest, opts ...grpc.CallOption) (*GetPeerInfoResponse, error) {
	...
	err := grpc.Invoke(ctx, "/peer.grpc.PeerService/GetPeerInfo", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func init() {
	proto.RegisterFile("github.com/aperturerobotics/bifrost/peer/grpc/grpc.proto", fileDescriptor_grpc_c05c4816a80f1e74)
}

var fileDescriptor_grpc_c05c4816a80f1e74 = []byte{
