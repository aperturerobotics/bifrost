 ...
 */
export interface IdentifyRequest extends Message<IdentifyRequest> {
  /**
 ...
 */
export interface IdentifyResponse extends Message<IdentifyResponse> {
  /**
 ...
 */
export interface GetPeerInfoRequest extends Message<GetPeerInfoRequest> {
  /**
 ...
 */
export interface PeerInfo extends Message<PeerInfo> {
  /**
 ...
 */
export interface GetPeerInfoResponse extends Message<GetPeerInfoResponse> {
  /**
