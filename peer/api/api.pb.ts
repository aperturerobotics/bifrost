...
export const IdentifyRequest = {
  encode(message: IdentifyRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  async *encodeTransform(
    source: AsyncIterable<IdentifyRequest | IdentifyRequest[]> | Iterable<IdentifyRequest | IdentifyRequest[]>,
...
export const IdentifyResponse = {
  encode(message: IdentifyResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  async *encodeTransform(
    source: AsyncIterable<IdentifyResponse | IdentifyResponse[]> | Iterable<IdentifyResponse | IdentifyResponse[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
...
export const PeerInfo = {
  ...
  async *encodeTransform(
    source: AsyncIterable<PeerInfo | PeerInfo[]> | Iterable<PeerInfo | PeerInfo[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
...
export const GetPeerInfoResponse = {
  encode(message: GetPeerInfoResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  fromJSON(object: any): GetPeerInfoResponse {
    return {
      localPeers: Array.isArray(object?.localPeers) ? object.localPeers.map((e: any) => PeerInfo.fromJSON(e)) : [],
    };
  },
  ...
  toJSON(message: GetPeerInfoResponse): unknown {
    ...
    if (message.localPeers) {
      obj.localPeers = message.localPeers.map((e) => e ? PeerInfo.toJSON(e) : undefined);
    } else {
      obj.localPeers = [];
    }
    return obj;
  ...
  fromPartial<I extends Exact<DeepPartial<GetPeerInfoResponse>, I>>(object: I): GetPeerInfoResponse {
    const message = createBaseGetPeerInfoResponse();
    message.localPeers = object.localPeers?.map((e) => PeerInfo.fromPartial(e)) || [];
    return message;
  },
};
