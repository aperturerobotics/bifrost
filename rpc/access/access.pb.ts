...
export const LookupRpcServiceRequest = {
  encode(message: LookupRpcServiceRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): LookupRpcServiceRequest {
  ...
  fromPartial<I extends Exact<DeepPartial<LookupRpcServiceRequest>, I>>(object: I): LookupRpcServiceRequest {
    const message = createBaseLookupRpcServiceRequest();
...
export const LookupRpcServiceResponse = {
  encode(message: LookupRpcServiceResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): LookupRpcServiceResponse {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromPartial<I extends Exact<DeepPartial<LookupRpcServiceResponse>, I>>(object: I): LookupRpcServiceResponse {
    const message = createBaseLookupRpcServiceResponse();
...
export interface AccessRpcService {
   ...
   */
  LookupRpcService(request: LookupRpcServiceRequest): AsyncIterable<LookupRpcServiceResponse>;
  /**
   ...
   */
  CallRpcService(request: AsyncIterable<RpcStreamPacket>): AsyncIterable<RpcStreamPacket>;
}
...
export class AccessRpcServiceClientImpl implements AccessRpcService {
  ...
  LookupRpcService(request: LookupRpcServiceRequest): AsyncIterable<LookupRpcServiceResponse> {
    ...
    const result = this.rpc.serverStreamingRequest(this.service, "LookupRpcService", data);
    return LookupRpcServiceResponse.decodeTransform(result);
  }

  CallRpcService(request: AsyncIterable<RpcStreamPacket>): AsyncIterable<RpcStreamPacket> {
    const data = RpcStreamPacket.encodeTransform(request);
    const result = this.rpc.bidirectionalStreamingRequest(this.service, "CallRpcService", data);
