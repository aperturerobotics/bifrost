...
export const Exponential = {
  ...
  fromJSON(object: any): Exponential {
    return {
      ...
      randomizationFactor: isSet(object.randomizationFactor)
        ? Number(object.randomizationFactor)
        : 0,
      maxElapsedTime: isSet(object.maxElapsedTime)
        ? Number(object.maxElapsedTime)
        : 0,
    }
  },
  ...
  toJSON(message: Exponential): unknown {
    ...
    message.randomizationFactor !== undefined &&
      (obj.randomizationFactor = message.randomizationFactor)
    message.maxElapsedTime !== undefined &&
