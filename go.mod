...
require (
	github.com/aperturerobotics/controllerbus v0.17.1-0.20221017024501-91b25a571e35
	github.com/aperturerobotics/entitygraph v0.3.1
	github.com/aperturerobotics/starpc v0.12.3-0.20221016005912-7bacc93ac67f
)
