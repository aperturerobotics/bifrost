...
require (
	...
	github.com/multiformats/go-multiaddr v0.0.2-0.20190227131035-ce21123d5172
	github.com/multiformats/go-multiaddr-dns v0.0.2-0.20190227170953-25bd1ef04b29 // indirect
